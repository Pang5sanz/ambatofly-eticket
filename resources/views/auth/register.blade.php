...
<head>
    ...
    <title>Register - E-Ticket LSP RPL</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        body::before {
            ...
            inset: 0;
            background:
                radial-gradient(circle at 15% 25%, rgba(255, 255, 255, 0.24), transparent 24%),
                radial-gradient(circle at 85% 15%, rgba(0, 123, 255, 0.18), transparent 20%),
                radial-gradient(circle at 70% 80%, rgba(255, 209, 193, 0.2), transparent 18%);
            pointer-events: none;
        }
        .page-wrapper {
            min-height: 100vh;
...
<div class="page-wrapper">
    <div class="auth-card">
        <div class="hero-panel">
            <h1>Ambatofly</h1>
            <p>Nikmati Perjalanan yang Lebih Mudah dengan Ambatofly</p>
